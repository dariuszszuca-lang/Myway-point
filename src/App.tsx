...
function Dashboard() { return <div className="text-2xl font-bold">Dashboard w budowie</div> }
function CalendarView() { return <div className="text-2xl font-bold">Kalendarz w budowie</div> }