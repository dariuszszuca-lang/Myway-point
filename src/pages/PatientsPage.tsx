...
export function PatientsPage() {
    ...
    const handleOpenModalForCreate = () => {
        if (!capabilities.canManagePatients) return;
  ...
  return (
    <>
      <div className="bg-white rounded-2xl shadow-soft border border-slate-200 overflow-hidden animate-fade-in">
        ...
        {loading ? (
            ...
            <thead className="bg-slate-50/80">
                ...
                {capabilities.canManagePatients && <th className="p-5"></th>}
                </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
                {patients.map(p => {
                    ...
                    <tr key={p.id} className="hover:bg-slate-50 transition-colors group">
                        ...
                        {capabilities.canManagePatients && <td className="p-5 text-right">
      ...
      {capabilities.canManagePatients && <PatientModal
        isOpen={isModalOpen}
